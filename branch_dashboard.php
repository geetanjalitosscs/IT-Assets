...
try {
    ...
    // Get statistics for current branch
    ...
    // Recent activities for current branch
    $stmt = $pdo->prepare("
        SELECT 'system' as type, s.system_code, e.full_name as employee_name, sh.assigned_date
